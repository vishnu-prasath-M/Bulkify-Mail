    ...
    <div>
      ...
      <div className="bg-[url('../src/assets/images/bgban2.png')] h-screen bg-cover w-full items-center justify-center flex">
        <div className="flex flex-col items-center gap-5 mt-16 w-fit p-10 shadow-md rounded-xl backdrop-blur-lg">
          {/* <div className="border-4 border-dashed border-gray-500 p-10 w-96">
            <input type="file" />
          </div> */}
        ...
        >
          ...
          <p className="text-blue-600">click to select one</p>
              ...
              {file && (
                ...
                {/* Text Area */}
          <div>
            <textarea className="bg-white border p-10 px-20 rounded-sm shadow-md" placeholder="Enter The Email Text..." onChange={handlemsg}></textarea>
          </div>

          {/* buttons */}
          <div className="flex gap-28">
            <button className=" border border-gray-400 p-2 rounded px-5 hover:bg-blue-700 hover:text-white">Cancel</button>
            <button className="bg-blue-500 p-2 px-5 rounded border-blue-500 border hover:bg-blue-700 text-white" onClick={send}>{status ? "Sending.." : "Send"}</button>
          </div>
        </div>
      </div>
